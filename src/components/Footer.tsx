        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-x-8 gap-y-8">
          ...
          <div className="lg:col-span-1 min-w-[180px]">
            <div className="mb-6 flex flex-col items-start">
              ...
              <div className="text-md text-[#2d2d2d] mb-1">Professional car air conditioning services with over 30 years of experience. Trusted by customers nationwide for quality and reliability.</div>
            </div>
            <div className="flex space-x-4">
              {/* Facebook */}
              <a href="http://www.facebook.com/PunjabCarAc" target="_blank" rel="noopener noreferrer" className="text-[#2d2d2d] hover:text-white transition-colors" aria-label="Facebook">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M22.675 0h-21.35C.595 0 0 .592 0 1.326v21.348C0 23.408.595 24 1.325 24h11.495v-9.294H9.692v-3.622h3.128V8.413c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.797.143v3.24l-1.918.001c-1.504 0-1.797.715-1.797 1.763v2.313h3.587l-.467 3.622h-3.12V24h6.116C23.406 24 24 23.408 24 22.674V1.326C24 .592 23.406 0 22.675 0" />
                </svg>
              </a>
              {/* Google Maps */}
              <a href="https://maps.app.goo.gl/risMNUN4yaSqm4ug8" target="_blank" rel="noopener noreferrer" className="text-[#2d2d2d] hover:text-white transition-colors" aria-label="Google Maps">
            ...
            <ul className="space-y-3">
              {loadingServices ? (
                ...
                services.map(service => (
                  <li key={service._id}>
                    <Link href={`/services/${servicesApi.generateSlug(service.title, service._id)}`} className="text-[#2d2d2d] hover:text-white transition-colors">
                      {service.title}
                    </Link>
                  </li>
                ))
              ) : (
                <li className="text-[#2d2d2d]">No services available</li>
              )}
            </ul>
          </div>
          ...
          <div className="min-w-[180px]">
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/our-brands" className="text-[#2d2d2d] hover:text-white transition-colors">
                  Our Brands
                </Link>
              </li>
              <li>
                <Link href="/our-team" className="text-[#2d2d2d] hover:text-white transition-colors">
                  Our Team
                </Link>
              </li>
              <li>
                <Link href="/company-profile" className="text-[#2d2d2d] hover:text-white transition-colors">
                  Company Profile
                </Link>
              </li>
              <li>
                <Link href="/sub-dealers" className="text-[#2d2d2d] hover:text-white transition-colors">
                  Sub Dealers
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/get-quote" className="text-[#2d2d2d] hover:text-white transition-colors">
                  Get Quote
                </Link>
              </li>
              <li>
                <Link href="/blogs" className="text-[#2d2d2d] hover:text-white transition-colors">
                  Blog
                </Link>
              </li>
            </ul>
          ...
          <div className="min-w-[180px]">
            ...
            <div className="text-[#2d2d2d] space-y-1 mb-6">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-[#2d2d2d]">Landline: 92-42-36305101, 92-42-36361648</span>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-punjabac-brand-light flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-[#2d2d2d]">Cell: 92-345-8428889</span>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-punjabac-brand-light flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-[#2d2d2d]">info@punjabac.com</span>
              </div>
            </div>
          </div>
        </div>
