    ...
    <div className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 overflow-hidden flex flex-col">
      ...
      <div className="p-6 flex flex-col flex-1">
        ...
        <a
          ...
          className="mt-auto inline-block bg-wingzimpex-brand text-white px-5 py-2 rounded-lg font-semibold hover:bg-wingzimpex-brand-light transition-colors text-center"
        >
          Read More
        </a>
      </div>
