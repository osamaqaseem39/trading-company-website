...
export default function Hero() {
  return (
    <section className="relative bg-[#ededed] overflow-hidden">
      <div className="relative max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          {/* Left Content */}
          <div className="text-center lg:text-left">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#001a33] leading-tight">
            ...
            <p className="mt-6 text-xl text-[#001a33] leading-relaxed max-w-2xl mx-auto lg:mx-0">
            ...
            <div className="mt-12 flex flex-wrap justify-center lg:justify-start gap-8">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-[#001a33] font-medium">Global Sourcing</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-8 h-8 bg-sandstone rounded-full flex items-center justify-center border border-emeraldPine">
                  <svg className="w-5 h-5 text-emeraldPine" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-[#001a33] font-medium">Quality Assurance</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-8 h-8 bg-sandstone rounded-full flex items-center justify-center border border-emeraldPine">
                  <svg className="w-5 h-5 text-emeraldPine" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-[#001a33] font-medium">On-Time Delivery</span>
              </div>
            </div>
            <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <a
                href="/contact"
                className="px-8 py-4 rounded-lg font-semibold text-lg shadow-lg bg-[#001a40] text-white hover:bg-[#001a33] transition-colors"
              >
                Get in Touch
              </a>
              <a
                href="/products"
                className="px-8 py-4 rounded-lg font-semibold text-lg bg-[#001a40] text-white hover:bg-[#001a33] transition-colors"
              >
                Our Products
              </a>
            </div>
